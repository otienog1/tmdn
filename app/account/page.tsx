                        ...
                        <div className='mt-4 mb-8 relative'>
                            <div className='relative block'>
                                ...
                                <span className='cursor-pointer h-[41px] bg-white pl-[5px] flex absolute top-[2px] right-2.5'>
                                    <span className='self-center pt-[2px] pr-[7px] text-xs leading-3 cursor-pointer none'>Show</span>
                                    <span className='self-center pt-[2px] pr-[7px] text-xs leading-3 cursor-pointer flex'>Hide</span>
                                    <svg className='none self-center' width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
